...
const prepareError = function prepareError(err, req, res, next) {
  ...
  res.set({
    ...
    "Cache-Control":
      "no-cache, private, max-stale=0, post-check=0, pre-check=0 no-store, must-revalidate"
  });
...
module.exports = {
  ...
  handleJSONResponse: [prepareError, JSONErrorRenderer],
  // HTML based errors from the web-console
  handleHTMLResponse: [prepareError, HTMLRenderer],
